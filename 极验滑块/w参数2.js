...
window.performance.timing = {
    ...
    'unloadEventStart' : start_time + 742,
    "unloadEventEnd" : start_time + 742,
    "redirectStart" : 0,
    "redirectEnd" : 0,
    "fetchStart" : start_time + 32,
    "domainLookupStart" : start_time + 39,
    "domainLookupEnd" : start_time + 187,
    "connectStart" : start_time + 187,
    "connectEnd" : start_time + 450,
    "secureConnectionStart" : start_time +120,
    "requestStart" : start_time + 210,
    "responseStart" : start_time + 220,
    "responseEnd" : start_time + 320,
    "domLoading" : start_time + 520,
    "domInteractive" : start_time + 550,
    "domContentLoadedEventStart" : start_time + 570,
    "domContentLoadedEventEnd" : start_time + 590,
    "domComplete" : start_time +1172,
    "loadEventStart" : start_time +1172,
    "loadEventEnd": start_time +1172
    // connectEnd: 1673337524976,
    // connectStart: 1673337524713,
    // domComplete: 1673337525701,
    // domContentLoadedEventEnd: 1673337525695,
    // domContentLoadedEventStart: 1673337525694,
    // domInteractive: 1673337525694,
    // domLoading: 1673337525270,
    // domainLookupEnd: 1673337524713,
    // domainLookupStart: 1673337524565,
    // fetchStart: 1673337524558,
    // loadEventEnd: 1673337525701,
    // loadEventStart: 1673337525701,
    // navigationStart: 1673337524526,
    // redirectEnd: 0,
    // redirectStart: 0,
    // requestStart: 1673337524976,
    // responseEnd: 1673337525263,
    // responseStart: 1673337525262,
    // secureConnectionStart: 1673337524828,
    // unloadEventEnd: 1673337525268,
    // unloadEventStart: 1673337525268
}
...
function getW(gt, challenge,arr,c,s) {
    sj = e()
    u = new _fuck_me()['encrypt'](sj)
    // arr = [
    //     [
    //         -48,
    //         -27,
    ...
    //     ]
    // ]
    aa = _fuck_arr['$_BBEM'] (   _fuck_arr['$_FDU'](arr), c, s) //
    passtime = arr[arr.length - 1][2]
    x = arr[arr.length - 1][0] - arr[1][0]
    console.log(passtime,x)
    o = {
        'aa' : aa,
        'ep':_fuck_ne["$_CCCG"](),
        'h9s9': "1816378497",
        ...
        'lang': "zh-cn",
        'passtime' : passtime,
        'rp': _fuck_X(  gt + challenge['slice'](0, 32) + passtime),
        'userresponse': _fuck_H(x,challenge)
    }

    //{lang: "zh-cn", userresponse: "1ddd1d1d11d11d158", passtime: 302, imgload: 445, aa: "S-/101F2311//--(!!Nyt)))(((r(((((((ttt(!!(.1112M011c1120111111$*L", …}

    // aa: "S-/101F2311//--(!!Nyt)))(((r(((((((ttt(!!(.1112M011c1120111111$*L"
    // ep: _fuck_ne()
    // h9s9: "1816378497"
    // imgload: 400
    // lang: "zh-cn"
    // passtime: 数组3 最大值
    // rp: "c3f988c28055d1497cb391dcf8f4ee8c" _fuck_X(  i['gt'] + i['challenge']['slice'](0, 32) + o['passtime']);
    // userresponse: _fuck_H(x,challenge)    x  数组移动距离

    // l = _fuck_zl['encrypt']( JSON.stringify(o) , e())

    // console.log(u)
    // console.log(_fuck_ne())

    console.log(o)
    console.log(JSON.stringify(o))
    l = _fuck_zl['encrypt'](JSON.stringify(o), sj)
    console.log(l)
    h = _fuck_S["$_FEr"](l)
    w = h + u
...
